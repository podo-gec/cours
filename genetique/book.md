...
- savoir si un gène a une expression autonome cellulaire ou non. Dans ce cas, on observe des spots jumeaux. Ce n 'est pas le cas, si le produit du gène diffuse d'une cellule à une autre, le produit sauvage diffusera à partir des cellules sauvages qui entoure le spot mutant. Celui-ci ne sera donc pas visible.
...
# Chapitre 7: analyse phénotypique
